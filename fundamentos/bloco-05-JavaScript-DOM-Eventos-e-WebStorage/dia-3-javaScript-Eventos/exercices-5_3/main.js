...
meuTop3.addEventListener('dblclick', irParaPagina)
function irParaPagina(){
    window.location.href ='https://matheusnf123.github.io/'
}

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;
function mudarColor(){
    meuTop3.style.color = 'red'
}
meuTop3.addEventListener('mouseenter', mudarColor)
